function moduleProject3() {
  ...
  function buildLearnerCard(learner, languages) {
    ...
    const favLanguage = languages.find(
      (lang) => lang.id === learner.favLanguage
    );
  ...
  function buildFooter(footerData) {
    ...
    copyright.textContent = `copyright ${footerData.companyName.toUpperCase()} ${currentYear}`;
